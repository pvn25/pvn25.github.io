...
* My research interests lies in two directions (1) Simplifying the process of sourcing the data for ML (2) Seamlessly integrating structured and speech data types by designing new speech-augmented systems that adapts speech recognition for querying and make it easier to analyze data through speech.
